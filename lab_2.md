...
```
Отмечу, что я специально закомментил проводящуюся в конце сортировку вставками. Она имеет квадратичную ассимтотику, и, как я увидел, убивает практически все различие между последовательностями. Поэтому я исследовал только ассимптотику предварительных проходов. Ниже графики для 1, 2 и 3 последовательностей.
